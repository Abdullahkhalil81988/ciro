...
const styles = StyleSheet.create({
  ...
  compLabel: { fontSize: 9, color: '#64748B', fontWeight: '700', letterSpacing: 1, marginTop: 6 },
  ...
  reductionLabel: { fontSize: 9, color: '#64748B' },
  ...
  avoidedDetail: { fontSize: 12, color: '#94A3B8', lineHeight: 17 },
  ...
  ticketSub: { fontSize: 11, color: '#94A3B8', marginTop: 2 },
