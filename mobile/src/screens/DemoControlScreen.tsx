...
const styles = StyleSheet.create({
  ...
  statusLabel: { fontSize: 10, color: '#64748B', fontWeight: '700' },
  statusVal: { fontSize: 12, color: '#22C55E', fontWeight: '600' },
  sectionLabel: { fontSize: 10, color: '#64748B', fontWeight: '700', letterSpacing: 1.5, marginBottom: 10, marginTop: 4 },
  scenarioCard: { backgroundColor: '#1E293B', borderRadius: 12, padding: 14, marginBottom: 10 },
  scenarioHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  scenarioName: { fontSize: 15, fontWeight: '700', color: '#F1F5F9' },
  sevBadge: { borderRadius: 5, paddingHorizontal: 8, paddingVertical: 3 },
  sevText: { fontSize: 10, fontWeight: '700' },
  scenarioDesc: { fontSize: 12, color: '#64748B', marginBottom: 10, lineHeight: 17 },
  runBtn: { paddingVertical: 10 },
  resultCard: { backgroundColor: '#1E293B', borderRadius: 12, padding: 14 },
